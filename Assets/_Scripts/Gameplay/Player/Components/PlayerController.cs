...
namespace Root.Player.Components
{
    public class PlayerController : PlayerComponent
    {
        ...
        public void DoSpearHop()
        {
            ...
            rb.linearVelocity = new Vector2(rb.linearVelocity.x, spearHopForce);
        ...
        private void HorizontalMovement()
        {
            ...
            {
                Move(Mathf.Lerp(rb.linearVelocity.x, 0f, decceleration));
            ...
            else
            {
                ...
                Move(Mathf.Lerp(rb.linearVelocity.x, input.horizontalInput * speed, acceleration));
            }
        }
        ...
        private void JumpHandling()
        {
            ...
            void HandleFalling()
            {
                if (rb.linearVelocity.y >= Mathf.Epsilon) return;
        ...
        public IEnumerator OnDash(InputAction.CallbackContext context)
        {
            ...
            while (dashTimer > 0)
            {
                rb.linearVelocity = new Vector2(facingDirection * dashSpeed * Time.deltaTime, 0f);
