...
namespace Root.LevelLoading
{
    public class LevelManager : MonoBehaviour
    {
        ...
        private void StartLoadProcess(int targetLevelIndex)
            => StartCoroutine(LoadProcessBehaviour.LoadProcess(levelIndex: targetLevelIndex));

        private void StartLoadProcess(PassageHandle targetLevelHandle)
            => StartCoroutine(LoadProcessBehaviour.LoadProcess(passageHandle: targetLevelHandle));
    }
}